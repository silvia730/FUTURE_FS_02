...
// Comprehensive fallback data mirroring the full FakeStoreAPI dataset
// This ensures that if the API rate-limits Vercel (403), the user sees exactly what they expect
const FALLBACK_PRODUCTS: Product[] = [
    ...
    },
    {
        ...
        category: "women's clothing",
        image: "https://fakestoreapi.com/img/71HblAHs5xL._AC_UY879_-2t.jpg",
